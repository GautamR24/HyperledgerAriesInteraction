   ...
   <>
    <nav className="navbar navbar-expand-lg  navbar bg-primary">
        <div className="container-fluid">
            <Link className="navbar-brand" to="/schema">Issuer</Link>
            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <Link className="nav-link" to="/schema">create schema</Link>
                </li>
                <li className="nav-item">
                <Link className="nav-link" to="/definition">Credential definition</Link>
                </li>
                <li className="nav-item">
                <Link className="nav-link" to="/createInvitation">Create invitation</Link>
                </li>
                <li className="nav-item">
